...
in
{
  options.myModules.autoUpgrade = {
    ...
    delayForInternet = mkOption {
      type = types.bool;
      description = "Wait for the Internet to be up before trying to update. This is usefull for Laptop. But it pings google.";
      default = false;
    };
    branch = mkOption {
