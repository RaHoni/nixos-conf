...
let
  smbpass = with config.users.users; pkgs.writeText "smbpass" ''
    ...
    christoph:${toString (christoph.uid - 1000)}:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX:00339E26411CF8BFADA8361A497EBDFC:[U          ]:LCT-64FC9B9D:
