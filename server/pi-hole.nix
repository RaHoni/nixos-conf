...
in
{
  ...
  systemd.services.pi-hole-adlists = {
    ...
    script = ''
      retry -t 5 curl -X POST "http://${ipv4}:80/api/lists" -H 'accept: application/json' -H 'content-type: application/json' -d '{"address":[
      ...
      ],"type":"block","comment":"Added at setup","groups":[0],"enabled":true}'
